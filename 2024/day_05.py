...
# I knew this would be badly inefficient but it turned out to be even worse than expected, but is it worth a rewrite?
# Anyway, should use rules as an ordering function
